...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const ownerNumber = '6281246114524@c.us'
        ...
        case '#donasi':
        case '#donate':
            client.sendLinkWithAutoPreview(from, 'https://wa.me/6281246114524', donate)
            break
        case '#tts':
        ...
        case '#fb':
            ...
            break
        case '#creator':
            client.sendContact(from, '6281246114524@c.us')
            break
        case '#ig':
